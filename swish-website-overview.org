...
**** markdown
creating-a-validated-events-database.md 
...
*** 2013-04-15-postgis-utils-on-windows header
 _posts/2013-04-15-postgis-utils-on-windows.md
#+begin_src markdown :tangle no :exports none :eval no :padline no
---
...
_posts/2013-04-19-a-swish-user-test-report.md
#+begin_src markdown :tangle no  :exports none :eval no :padline no
  ---
...
_posts/2013-04-26-extract-weather-from-grids.md
#+begin_src markdown :tangle no :exports none :eval no :padline no
  ---
...
#+name:set-up-swish-computer-header
 _posts/2013-04-27-set-up-swish-computer.md
#+begin_src markdown :tangle no :exports none :eval no :padline no
  ---
...
#+name:ExtractAWAPdata4locations-header
 _posts/2013-05-03-extract-awap-data-4-locations.md
#+begin_src markdown :tangle no :exports none :eval no :padline no
---
...
**** post
#+name:set-up-swish-computer-header
 _posts/2013-05-09-set-up-r-on-ms-windows.md
#+begin_src markdown :tangle no :exports none :eval no :padline no
  ---
...
_posts/2013-05-13-awapgrids-vs-stations.md 
#+begin_src markdown :tangle no :exports none :eval no :padline no
---
...
_posts/2013-06-05-developing-with-workflows.md
#+begin_src markdown :tangle no :exports none :eval no :padline no
---
...
~/projects/swish-climate-impact-assessment.github.com/_posts/2013-10-26-finishing-up.md
...
** 2015-12-02-reboot
#+name:reboot-header
#+begin_src markdown :tangle _posts/2015-12-02-reboot.md :exports none :eval no :padline no
---
name: reboot
layout: post
title: Reboot
...
** 2018-11-02-reboot-again
#+name:reboot-header
#+begin_src markdown :tangle _posts/2018-11-02-reboot-again.md :exports none :eval no :padline no
---
name: reboot-again
layout: post
title: Reboot again
...
#+end_src
* snip
              <!--><a class="Dataset Catalogue" href="http://115.146.93.108:8181/ddiindex">Dataset Catalogue →</a> -->
              <!-- <p></p> -->
              <!-- <a class="Dataset Registry" href="http://115.146.93.225:8080/apex/f?p=102">Dataset Registry →</a> -->
              <!-- <p></p> -->
              <!-- <a class="OpenGeo Suite" href="http://115.146.93.108:8181/dashboard">OpenGeo Suite →</a> -->
              <!-- <p></p> -->
